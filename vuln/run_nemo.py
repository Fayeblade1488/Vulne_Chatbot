...
DEFAULT_CONFIG_PATH = os.path.join(PROJECT_ROOT, 'config_NeMo')
LOG_FILE = os.path.join(SCRIPT_DIR, 'nemo_benchmark.log')
...
class NemoBenchmarker:
    def __init__(
        ...
        if output_dir:
            ...
            self.results_dir = os.path.join(SCRIPT_DIR, f"nemo_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', type=str, default=DEFAULT_CONFIG_PATH, help='Path to NeMo config directory.')
